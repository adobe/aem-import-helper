...
**Required:**
* **token**: Absolute path to the file containing the IMS token for your DA environment, or the token value.
...
* **da-folder**: Absolute path to the HTML folder containing the HTML pages, generated by the importer tool.
* **asset-list**: Absolute path to the asset list file (`asset-list.json`), which contains list of asset urls.

**Optional:**
* _output_ [default='da-assets']: Absolute path to the output folder where the downloaded assets will be stored.
