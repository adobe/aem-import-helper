...
**Optional:**
* _output_: Absolute path to the output folder where the downloaded assets will be stored. Default is `aem-assets`.
* _keep:_ Keep the downloaded assets in the output folder after execution. Default is `false`.
